...
public class AirPushStandard extends Advertising{
	...
	class AirPushListener implements AdListener{
		...
		public void onAdError(String errorMessage) {
			...
			Log.v(this.getClass().getSimpleName(), "onAdError(): "+errorMessage);	
		}
		@Override
		public void noAdListener() {
			 //this will get called when ad is not available 
			Log.v(this.getClass().getSimpleName(), "noAdListener()");
			loadInterstitial();
		}
		@Override
		public void onAdCached(AdType adType) {
			//This will get called when an ad is cached. 
			Log.v(this.getClass().getSimpleName(), "onAdCached(): "+adType.name());	
		}
		@Override
		public void onAdClickedListener() {
			 //This will get called when ad is clicked.
			Log.v(this.getClass().getSimpleName(), "onAdClickedListener()");	
		}
		@Override
		public void onAdClosed() {
			// This will be called by SDK when the SmartWall ad is closed.
			Log.v(this.getClass().getSimpleName(), "onAdClosed()");
...
//			loadInterstitial(); 
		...
		public void onAdExpandedListner() {
			...
			Log.v(this.getClass().getSimpleName(), "onAdExpandedListener()");
		}
		@Override
		public void onAdLoadedListener() {
			  //This will get called when an ad has loaded.
			Log.v(this.getClass().getSimpleName(), "onAdLoadedListener()");
		}
		@Override
		...
		public void onAdShowing() {
			...
			Log.v(this.getClass().getSimpleName(), "onAdShowing()");
		}
		@Override
		public void onCloseListener() {
			// when an ad is closing/resizing from an expanded state
			Log.v(this.getClass().getSimpleName(), "onCloseListener()");
		}
		@Override
